...
public class Employee extends Member {
	...
	public Employee(String name, String id, String pw, String registration, String phone, String position, String line,
	...
	public String toString() {
		return String.format("[이름: %s, ID: %s, PW: %s, 주민등록번호: %s, 전화번호: %s, 직급: %s, 호선: %s, 역: %s, 접근권한: %s]\r\n",
				this.name, this.id, this.pw, this.registration, this.phone, this.position, this.line, this.station,
				this.level);
	}
